#This script should superceed runCP.sh
...
#Import stuff
parser.add_argument('-n','--num_samples',help='number of samples int >= 1 default = 1000',type=int,
	default=1000)
parser.add_argument('-b','--num_burn',help='burn in, default = 500',type=int,
	default=500)
parser.add_argument('-s','--sample_block',help='sampling block size, this should be tuned per problem',type=int,
	default=1000)
